 ...
 * Generated for Laravel 6.13.1 on 2020-01-29 22:14:12.
 *
...
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Article[]|Article create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Article[]|Article make($attributes = [])
    */
    class ArticleFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
...
namespace App {
    /**
    * @method \Illuminate\Database\Eloquent\Collection|Tag[]|Tag create($attributes = [])
    * @method \Illuminate\Database\Eloquent\Collection|Tag[]|Tag make($attributes = [])
    */
    class TagFactoryBuilder extends \Illuminate\Database\Eloquent\FactoryBuilder {}
}
namespace App {
    /**
